...
// import { CountryCode, ProcessorTokenCreateRequest, ProcessorTokenCreateRequestProcessorEnum, Products } from "plaid/dist/api";
...
export const signUp = async ({password, ...userData}:SignUpParams) => {
  ...
  let newUserAccount;
    try {
        //mutation ,modify database , fetch as well
